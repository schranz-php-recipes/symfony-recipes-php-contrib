...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->set('Buzz\Browser')
        ->args([service('Buzz\Client\BuzzClientInterface'), service('Psr\Http\Message\RequestFactoryInterface')])
        ->call('addMiddleware', [service('buzz.middleware.content_length')])
        ->call('addMiddleware', [service('buzz.middleware.logger')]);
